...
function M.setup()
  local keymap = {
    ...
    { "<leader>dd", "<cmd>lua require'dapui'.toggle()<cr>", desc = "Toggle UI", nowait = false, remap = false },
    ...
    { "<leader>dr", "<cmd>lua require'dapui'.open({reset=true})<cr>", desc = "Reset UI", nowait = false, remap = false },
